...
// type pb6de49a96.Handlers in package:github.com/starter-go/cli/implements/core
//
// id:com-b6de49a969de63e2-core-Handlers
// class:class-1336d65edeed550b78a5d5b61e92d726-HandlerRegistry
// alias:
// scope:singleton
//
type pb6de49a969_core_Handlers struct {
}

func (inst* pb6de49a969_core_Handlers) register(cr application.ComponentRegistry) error {
	r := cr.NewRegistration()
	r.ID = "com-b6de49a969de63e2-core-Handlers"
...
func (inst* pb6de49a969_core_Handlers) new() any {
    return &pb6de49a96.Handlers{}
}

func (inst* pb6de49a969_core_Handlers) inject(injext application.InjectionExt, instance any) error {
	ie := injext
	com := instance.(*pb6de49a96.Handlers)
	nop(ie, com)
...
// type pb6de49a96.Filters in package:github.com/starter-go/cli/implements/core
//
// id:com-b6de49a969de63e2-core-Filters
// class:class-1336d65edeed550b78a5d5b61e92d726-FilterRegistry
// alias:
// scope:singleton
//
type pb6de49a969_core_Filters struct {
}

func (inst* pb6de49a969_core_Filters) register(cr application.ComponentRegistry) error {
	r := cr.NewRegistration()
	r.ID = "com-b6de49a969de63e2-core-Filters"
...
func (inst* pb6de49a969_core_Filters) new() any {
    return &pb6de49a96.Filters{}
}

func (inst* pb6de49a969_core_Filters) inject(injext application.InjectionExt, instance any) error {
	ie := injext
	com := instance.(*pb6de49a96.Filters)
	nop(ie, com)
